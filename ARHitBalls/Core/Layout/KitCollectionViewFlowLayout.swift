//
//  KitCollectionViewFlowLayout.swift
//  ARHitBalls
//
...
class KitCollectionViewFlowLayout: UICollectionViewFlowLayout {
    ...
    override func layoutAttributesForElements(in rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
        ...
        guard case let newAttributesArray as [UICollectionViewLayoutAttributes] = NSArray(
    ...
    func resetContentInset() {
        ...
        collectionView.contentInset = UIEdgeInsets.init(
            top: 0,
            left: 0,
            bottom: 0,
            right: 0
